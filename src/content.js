...
function greenFunction() {
  ...
  var importedFontTransReq =
    /(@font-face)|(woff?2)|(fonts.googleapis)|(.tff)|(fonts.shopifycdn)|(cloud.typography)|(.otf)|(.eot)|(webfonts)/;
  var imageTransReq =
    /(.png)|(.jpeg)|(.gif)|(.jpg)|(.tiff)|(.svg)|(webp)|(avif)|(.ico)/;
  ...
  netA.sort(function (a, b) {
    return b - a;
  });
  netB.sort(function (a, b) {
    return b - a;
  });
  netC.sort(function (a, b) {
    return b - a;
  });
...
console.log('NetC: '+netC);*/
  ...
  if (transferTotal / 1024 / 1024 / 1024 > 1) {
    transferLabel =
      (transferTotal / 1024 / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[3];
  } else if (transferTotal / 1024 / 1024 > 1) {
    transferLabel =
      (transferTotal / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  } else if (transferTotal / 1024 > 1) {
    transferLabel =
      (transferTotal / 1024).toFixed(2).toString() + arrayLabel[1];
  ...
  if (fullTotal / 1024 / 1024 / 1024 > 1) {
    sizeLabel =
      (fullTotal / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  ...
  if (num1TotSize / 1024 / 1024 / 1024 > 1) {
    num1TotSizeLab =
      (num1TotSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[3];
  } else if (num1TotSize / 1024 / 1024 > 1) {
    num1TotSizeLab =
      (num1TotSize / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[2];
  } else if (num1TotSize / 1024 > 1) {
    num1TotSizeLab =
      (num1TotSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
  ...
  if (num2TotSize / 1024 / 1024 / 1024 > 1) {
    num2TotSizeLab =
      (num2TotSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[3];
  } else if (num2TotSize / 1024 / 1024 > 1) {
    num2TotSizeLab =
      (num2TotSize / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[2];
  } else if (num2TotSize / 1024 > 1) {
    num2TotSizeLab =
      (num2TotSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
  ...
  if (num3TotSize / 1024 / 1024 / 1024 > 1) {
    num3TotSizeLab =
      (num3TotSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[3];
  } else if (num3TotSize / 1024 / 1024 > 1) {
    num3TotSizeLab =
      (num3TotSize / 1024 / 1024).toFixed(2).toString() +
      "<br>" +
      arrayLabel[2];
  } else if (num3TotSize / 1024 > 1) {
    num3TotSizeLab =
      (num3TotSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
  ...
  if (transferTotal > 0) {
    if (num1TransSize / 1024 / 1024 / 1024 > 1) {
      num1TransSizeLab =
        (num1TransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[3];
    } else if (num1TransSize / 1024 / 1024 > 1) {
      num1TransSizeLab =
        (num1TransSize / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[2];
    } else if (num1TransSize / 1024 > 1) {
      num1TransSizeLab =
        (num1TransSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
    } else if (num1TransSize >= 1) {
      num1TransSizeLab =
        num1TransSize.toFixed(2).toString() + "<br>" + arrayLabel[0];
    } else {
    ...
    if (num2TransSize / 1024 / 1024 / 1024 > 1) {
      num2TransSizeLab =
        (num2TransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[3];
    } else if (num2TransSize / 1024 / 1024 > 1) {
      num2TransSizeLab =
        (num2TransSize / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[2];
    } else if (num2TransSize / 1024 > 1) {
      num2TransSizeLab =
        (num2TransSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
    } else if (num2TransSize >= 1) {
      num2TransSizeLab =
        num2TransSize.toFixed(2).toString() + "<br>" + arrayLabel[0];
    } else {
    ...
    if (num3TransSize / 1024 / 1024 / 1024 > 1) {
      num3TransSizeLab =
        (num3TransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[3];
    } else if (num3TransSize / 1024 / 1024 > 1) {
      num3TransSizeLab =
        (num3TransSize / 1024 / 1024).toFixed(2).toString() +
        "<br>" +
        arrayLabel[2];
    } else if (num3TransSize / 1024 > 1) {
      num3TransSizeLab =
        (num3TransSize / 1024).toFixed(2).toString() + "<br>" + arrayLabel[1];
    } else if (num3TransSize >= 1) {
      num3TransSizeLab =
        num3TransSize.toFixed(2).toString() + "<br>" + arrayLabel[0];
    } else {
  ...
  if (cssTransSize / 1024 / 1024 / 1024 > 1) {
    CSSSizeLab =
      (cssTransSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  } else if (cssTransSize / 1024 / 1024 > 1) {
    CSSSizeLab =
      (cssTransSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
 ...
 APISizeLab = (((apiTransSize).toFixed(2)).toString() + arrayLabel[0]);
  ...
  if (jsTransSize / 1024 / 1024 / 1024 > 1) {
    jsSizeLab =
      (jsTransSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  } else if (jsTransSize / 1024 / 1024 > 1) {
    jsSizeLab =
      (jsTransSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  ...
  if (importedFontTransSize / 1024 / 1024 / 1024 > 1) {
    importedFontSizeLab =
      (importedFontTransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[3];
  } else if (importedFontTransSize / 1024 / 1024 > 1) {
    importedFontSizeLab =
      (importedFontTransSize / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[2];
  } else if (importedFontTransSize / 1024 > 1) {
    importedFontSizeLab =
      (importedFontTransSize / 1024).toFixed(2).toString() + arrayLabel[1];
  } else if (importedFontTransSize >= 1) {
    importedFontSizeLab =
      importedFontTransSize.toFixed(2).toString() + arrayLabel[0];
  } else {
  ...
  if (imageTransSize / 1024 / 1024 / 1024 > 1) {
    imgTransSizeLab =
      (imageTransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[3];
  } else if (imageTransSize / 1024 / 1024 > 1) {
    imgTransSizeLab =
      (imageTransSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  } else if (imageTransSize / 1024 > 1) {
    imgTransSizeLab =
      (imageTransSize / 1024).toFixed(2).toString() + arrayLabel[1];
 ...
 videoTransSizeLab = (((videoTransSize).toFixed(2)).toString() + arrayLabel[0]);
  ...
  if (otherTransSize / 1024 / 1024 / 1024 > 1) {
    otherTransSizeLab =
      (otherTransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[3];
  } else if (otherTransSize / 1024 / 1024 > 1) {
    otherTransSizeLab =
      (otherTransSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  } else if (otherTransSize / 1024 > 1) {
    otherTransSizeLab =
      (otherTransSize / 1024).toFixed(2).toString() + arrayLabel[1];
  ...
  if (cssTotSize / 1024 / 1024 / 1024 > 1) {
    cssTotLab =
      (cssTotSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  } else if (cssTotSize / 1024 / 1024 > 1) {
    cssTotLab =
      (cssTotSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
 ...
 apiTotLab = (((apiTotSize).toFixed(2)).toString() + arrayLabel[0]);
  ...
  if (jsTotSize / 1024 / 1024 / 1024 > 1) {
    jsTotLab =
      (jsTotSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  ...
  if (importedFontTotSize / 1024 / 1024 / 1024 > 1) {
    impFontLab =
      (importedFontTotSize / 1024 / 1024 / 1024).toFixed(2).toString() +
      arrayLabel[3];
  } else if (importedFontTotSize / 1024 / 1024 > 1) {
    impFontLab =
      (importedFontTotSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  } else if (importedFontTotSize / 1024 > 1) {
    impFontLab =
      (importedFontTotSize / 1024).toFixed(2).toString() + arrayLabel[1];
  ...
  if (imageTotSize / 1024 / 1024 / 1024 > 1) {
    imageLab =
      (imageTotSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  } else if (imageTotSize / 1024 / 1024 > 1) {
    imageLab =
      (imageTotSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
 ...
 videoLab = (((videoTotSize).toFixed(2)).toString() + arrayLabel[0]);
  ...
  if (otherTotSize / 1024 / 1024 / 1024 > 1) {
    otherLab =
      (otherTotSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
  } else if (otherTotSize / 1024 / 1024 > 1) {
    otherLab =
      (otherTotSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
  ...
  if (transferTotal > 0) {
    var percentCSS =
      ((cssTransSize / transferTotal) * 100).toFixed(2).toString() + "%";
    var percentJS =
      ((jsTransSize / transferTotal) * 100).toFixed(2).toString() + "%";
    var percentImFont =
      ((importedFontTransSize / transferTotal) * 100).toFixed(2).toString() +
      "%";
    var percentImg =
      ((imageTransSize / transferTotal) * 100).toFixed(2).toString() + "%";
    var otherImg =
      ((otherTransSize / transferTotal) * 100).toFixed(2).toString() + "%";

    var num1TransSizePercent =
      ((num1TransSize / transferTotal) * 100).toFixed(2).toString() + "%";
    var num2TransSizePercent =
      ((num2TransSize / transferTotal) * 100).toFixed(2).toString() + "%";
    var num3TransSizePercent =
      ((num3TransSize / transferTotal) * 100).toFixed(2).toString() + "%";
  } else {
    var percentCSS = "0 %";
    var percentJS = "0 %";
    var percentImFont = "0 %";
...
console.log('Other Tot: '+otherTotSize+' '+otherLab);*/
  ...
  var regEX =
    /(loading="lazy")|(class="lozad")|(class="b-lazy")|(class="lazyloaded)|(class="lazy")/;
  var result = "";
...
console.log(joinLLString);*/
  ...
  if (JSHeapSize / 1024 / 1024 / 1024 > 1) {
    jssSizeLabel =
      (JSHeapSize / 1024 / 1024 / 1024).toPrecision(3).toString() +
      arrayLabel[3];
  } else if (JSHeapSize / 1024 / 1024 > 1) {
    jssSizeLabel =
      (JSHeapSize / 1024 / 1024).toPrecision(3).toString() + arrayLabel[2];
  } else if (JSHeapSize / 1024 > 1) {
    jssSizeLabel =
      (JSHeapSize / 1024).toPrecision(3).toString() + arrayLabel[1];
  ...
  if (pagebytes / 1000000 > 1) {
    pagebytesLabel =
      (pagebytes / 1000000).toPrecision(2).toString() + lengthArray[0];
  } else {
    pagebytesLabel =
      (pagebytes / 1000).toPrecision(3).toString() + lengthArray[1];
  }
  ...
  var cacheMinutes = Math.floor(
    (cacheTime - (cacheDays * day + cacheHours * hour)) / minute,
  );
  var cacheSeconds = Math.floor(
    (cacheTime -
      (cacheDays * day + cacheHours * hour + cacheMinutes * minute)) /
      seconds,
  );
  ...
  if (backGroundColor.match(rgbaMatch)) {
    ...
    var subComColor =
      Math.abs(parseInt(colorArray[0]) - parseInt(colorArray[1])) +
      Math.abs(parseInt(colorArray[2]) - parseInt(colorArray[1])) +
      Math.abs(parseInt(colorArray[0]) - parseInt(colorArray[2]));
  ...
  switch (lazyLoadVal >= 0) {
    case lazyLoadVal >= 0.65:
      finalScore += 0.4;
      LazyLoadWeight = 0.4;
      break;
    case lazyLoadVal >= 0.4:
      finalScore += 0.3;
      LazyLoadWeight = 0.3;
      lowRec.push(301);
      break;
    case lazyLoadVal >= 0.25:
      finalScore += 0.2;
      LazyLoadWeight = 0.2;
      medRec.push(201);
      break;
  ...
  switch (susFormatVal >= 0) {
    case susFormatVal >= 0.7:
      finalScore += 0.4;
      imgTypeWeight = 0.4;
      break;
    case susFormatVal >= 0.5:
      finalScore += 0.3;
      imgTypeWeight = 0.3;
      lowRec.push(302);
      break;
    case susFormatVal >= 0.25:
      finalScore += 0.2;
      imgTypeWeight = 0.2;
      medRec.push(202);
      break;
  ...
  switch (resImgArray[0] >= 0) {
    case resImgArray[0] >= 0.7:
      finalScore += 0.4;
      resWeight = 0.4;
      break;
    case resImgArray[0] >= 0.5:
      finalScore += 0.35;
      resWeight = 0.35;
      lowRec.push(308);
      break;
    case resImgArray[0] >= 0.3:
      finalScore += 0.3;
      resWeight = 0.3;
      lowRec.push(308);
      break;
  ...
  var LazyLoadMax = Math.round(
    ((finalScore - LazyLoadWeight + 0.4) / maxScore) * 100,
  );

  //Empty Src Tags
  //var emptySrcMax = ((((finalScore-emptySRCWeight)+.2)/14.7)*100).toPrecision(2);
  var emptySrcMax = Math.round(
    ((finalScore - emptySRCWeight + 0.2) / maxScore) * 100,
  );

  // Cookies
  //var cookieMax = ((((finalScore-cookieWeight)+.4)/14.7)*100).toPrecision(2);
  var cookieMax = Math.round(
    ((finalScore - cookieWeight + 0.4) / maxScore) * 100,
  );

  // Redirects
  //var redirectMax = ((((finalScore-redirectWeight)+.1)/14.7)*100).toPrecision(2);
  var redirectMax = Math.round(
    ((finalScore - redirectWeight + 0.1) / maxScore) * 100,
  );

  // Style Sheet Files
  //var ssFileMax = ((((finalScore-ssFileWeight)+.2)/14.7)*100).toPrecision(2);
  var ssFileMax = Math.round(
    ((finalScore - ssFileWeight + 0.2) / maxScore) * 100,
  );

  // Internal Style Sheet
  //var intSSMax = ((((finalScore-intSSWeight)+.2)/14.7)*100).toPrecision(2);
  var intSSMax = Math.round(
    ((finalScore - intSSWeight + 0.2) / maxScore) * 100,
  );

  // Responsive Images
  //var resMax = ((((finalScore-resWeight)+.4)/14.7)*100).toPrecision(2);
  var resMax = Math.round(((finalScore - resWeight + 0.4) / maxScore) * 100);
  ...
  var fontMax = Math.round(((finalScore - fontWeight + 0.4) / maxScore) * 100);
  ...
  var lengthMax = Math.round(
    ((finalScore - lengthWeight + 1) / maxScore) * 100,
  );

  // Img Type Weight
  //var imgTypeMax = ((((finalScore-imgTypeWeight)+.4)/14.7)*100).toPrecision(2);
  var imgTypeMax = Math.round(
    ((finalScore - imgTypeWeight + 0.4) / maxScore) * 100,
  );
  ...
  cacheWeight;
  // Caching
  var cacheMax = Math.round(
    ((finalScore - cacheWeight + 0.4) / maxScore) * 100,
  );

  colorWeight;
  // Caching
  var colorMax = Math.round(
    ((finalScore - colorWeight + 0.2) / maxScore) * 100,
  );
  ...
  if (medRec.includes(206)) {
    ...
    if (imFontSize === 0) {
      ...
      imFontLabel =
        (imFontSize / 1024 / 1024 / 1024).toFixed(2).toString() + arrayLabel[3];
      medRec1.push(
        "Your imported fonts equate to " +
          imFontLabel +
          ", or " +
          ((imFontSize / transferTotal) * 100).toFixed(2) +
          "% of your total transfered size.<br>",
      );
    } else if (imFontSize / 1024 / 1024 > 1) {
      imFontLabel =
        (imFontSize / 1024 / 1024).toFixed(2).toString() + arrayLabel[2];
      medRec1.push(
        "Your imported fonts equate to " +
          imFontLabel +
          ", or " +
          (imFontSize / transferTotal) * 100 +
          "% of your total transfered size.<br>",
      );
  ...
  function transferFunction() {
    if (num1TransName.match(cssTransReq)) {
      ...
      transFuncVar =
        "Your largest Trans Size is an imported font file. All together, imported fonts required " +
        imFontLabel +
        " in transfered data.<br><br>";
    } else if (num1TransName.match(imageTransReq)) {
      transFuncVar =
        "Your largest Transfered Request is an image. Have you considered using an image compression tool? There are a lot found online, and they make a significant difference in image size.<br><br>";
    } else {
  ...
  function loadTimeFunction() {
    if (num1LoadName.match(cssTransReq)) {
      loadFuncVar =
        "Your longest loading request is an external stylesheet.<br><br>";
      ...
      loadFuncVar =
        "Your longest loading request is a javascript file.<br><br>";
    } else if (num1LoadName.match(importedFontTransReq)) {
      loadFuncVar =
        "Your longest loading request is an imported font file. In total, Imported Fonts required " +
        impFontReq +
        " seperate requests. <br><br>";
    } else if (num1LoadName.match(imageTransReq)) {
      loadFuncVar =
        "Your longest loading request is an image. Have you considered using an image compression tool? There are a lot found online, and they make a significant difference in image size.<br><br>";
    } else {
  ...
  function emptySRCFunction() {
    ...
    if (emptySrcType.includes(2)) {
      emptySrcVar +=
        'Instances of < script src=""> were found on page.<br><br>';
    }
    if (emptySrcType.includes(3)) {
      emptySrcVar +=
        'Instances of < link rel=stylesheet href=""> were found on page.<br><br>';
    }
    if (emptySrcType.includes(4)) {
      emptySrcVar +=
        'Instances of < button href=""> were found on page.<br><br>';
    }
  ...
  function jsFunction() {
    ...
    if (jsTransSize === 0) {
      ...
      jsTransLabel =
        (jsTransSize / 1024 / 1024 / 1024).toFixed(2).toString() +
        arrayLabel[3];
      jsFuncVar =
        "The total amount of all transfered Javascript Requests: " +
        jsTransLabel +
        ".<br><br>";
    } else if (jsTransSize / 1024 / 1024 > 1) {
      jsTransLabel =
  ...
  var counts = {
    ...
    percentImg,
    otherImg,
    num1TransSizePercent,
    num2TransSizePercent,
    num3TransSizePercent,
  };
